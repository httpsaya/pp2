...
class Icon:
    def __init__(self, place: pygame.Surface, img: pygame.Surface, size: tuple):
        self.place = place
...
def draw_interface(screen, mode, rect_img, circle_img, pen_img):
    global white_list, list_x, list_y
...
def main():
    global screen, mode, white_list, list_x, list_y, active_item, another_list
    ...
    while True:
        ...
        draw_interface(screen, mode, rect_img, circle_img, pen_img)
        pygame.display.flip()
